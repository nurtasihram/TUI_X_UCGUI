...
static CBITMAP _bmArrowL{ { 18, 30 }, 5, BPP_2, _pxArrowL, GUI_CursorPal };
CCURSOR CursorArrowL{ &_bmArrowL };
static CBITMAP _bmArrowLI{ { 18, 30 }, 5, BPP_2, _pxArrowL, GUI_CursorPalI };
...
static CBITMAP _bmArrowM{ { 12, 20 }, 3, BPP_2, _pxArrowM, GUI_CursorPal };
CCURSOR CursorArrowM{ &_bmArrowM };
static CBITMAP _bmArrowMI{ { 12, 20 }, 3, BPP_2, _pxArrowM, GUI_CursorPalI };
...
static CBITMAP _bmArrowS{ { 9, 15 }, 3, BPP_2, _pxArrowS, GUI_CursorPal };
CCURSOR CursorArrowS{ &_bmArrowS };
static CBITMAP _bmArrowSI{ { 9, 15 }, 3, BPP_2, _pxArrowS, GUI_CursorPalI };
