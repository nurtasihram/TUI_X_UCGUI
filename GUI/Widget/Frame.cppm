...
#pragma region Resize Control
	...
	static void _SetResizeCursor(int Mode) {
		...
		______XX,XX______,________,XXXX____,________,
		________,XX______,________,XX______,________};
		static CBITMAP _bmResizeCursorH{ { 17, 9 }, 5, BPP_2, _pxCurResizeH, GUI_CursorPal };
		...
		______XX,ooXX____,________,
		________,XX______,________};
		static CBITMAP _bmResizeCursorV{ { 9, 17 }, 3, BPP_2, _pxCurResizeV, GUI_CursorPal };
		...
		static CBITMAP _bmResizeCursorDD{ 13, 4, BPP_2, _pxCurResizeDD, GUI_CursorPal };
		...
		XXoooooo,XX______,________,________,
		XXXXXXXX,XXXX____,________,________};
		static CBITMAP _bmResizeCursorDU{ 13, 4, BPP_2, _pxCurResizeDU, GUI_CursorPal };
