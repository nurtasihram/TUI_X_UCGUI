...
struct WIDGET_EFFECT_3D : public WIDGET_EFFECT {
	void DrawUp(RECT r) const override {
		...
		GUI.Color(RGB_WHITE);
		GUI.DrawHLine(r.y0 + 1, r.x0 + 1, r.x1 - 2); /* Draw top line */
		GUI.DrawVLine(r.x0 + 1, r.y0 + 1, r.y1 - 2);
		/* Draw the dark sides */
		GUI.Color(RGBC::Gray(0x55));
		GUI.DrawHLine(r.y1 - 1, r.x0 + 1, r.x1 - 1);
		GUI.DrawVLine(r.x1 - 1, r.y0 + 1, r.y1 - 2);
	}
	void DrawDown(RECT r) const override {
		...
		GUI.DrawHLine(r.y0, r.x0, r.x1);
		GUI.DrawVLine(r.x0, r.y0 + 1, r.y1);
		GUI.Color(0x0);
		GUI.DrawHLine(r.y0 + 1, r.x0 + 1, r.x1 - 1);
		GUI.DrawVLine(r.x0 + 1, r.y0 + 2, r.y1 - 1);
		/* Draw the lower right sides */
		GUI.Color(RGB_WHITE);
		GUI.DrawHLine(r.y1, r.x0 + 1, r.x1);
		GUI.DrawVLine(r.x1, r.y0 + 1, r.y1);
		GUI.Color(RGBC::Gray(0xc0));
		GUI.DrawHLine(r.y1 - 1, r.x0 + 2, r.x1 - 1);
		GUI.DrawVLine(r.x1 - 1, r.y0 + 2, r.y1 - 1);
	}
...
struct WIDGET_EFFECT_3D1L : public WIDGET_EFFECT {
	void DrawUp(RECT r) const override {
		...
		GUI.DrawHLine(r.y0, r.x0, r.x1 - 1);
		GUI.DrawVLine(r.x0, r.y0 + 1, r.y1 - 1);
		/* Draw the lower right sides */
		GUI.Color(RGBC::Gray(0x60));
		GUI.DrawHLine(r.y1, r.x0, r.x1);
		GUI.DrawVLine(r.x1, r.y0, r.y1 - 1);
	}
	void DrawDown(RECT r) const override {
		/* Draw the upper left sides */
		GUI.Color(RGBC::Gray(0x60));
...
struct WIDGET_EFFECT_3D2L : public WIDGET_EFFECT {
	void DrawUp(RECT r) const override {
		...
		GUI.DrawVLine(r.x0, r.y0 + 1, r.y1 - 1);
		GUI.Color(RGBC::Gray(0xE7));
		GUI.DrawHLine(r.y0 + 1, r.x0 + 1, r.x1 - 2);
		GUI.DrawVLine(r.x0 + 1, r.y0 + 2, r.y1 - 2);
		/* Draw the lower right sides */
		GUI.Color(RGBC::Gray(0x60));
		GUI.DrawHLine(r.y1, r.x0, r.x1);
		GUI.DrawVLine(r.x1, r.y0, r.y1 - 1);
