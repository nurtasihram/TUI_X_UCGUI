...
/*256*/ MSG_TRANS(WM_KEYDOWN, 
	...
	((_CALL_(OnKeyDown))((UINT)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*257*/ MSG_TRANS(WM_KEYUP, 
	...
	((_CALL_(OnKeyUp))((UINT)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*258*/ MSG_TRANS(WM_CHAR, 
	...
	((_CALL_(OnChar))((TCHAR)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*259*/ MSG_TRANS(WM_DEADCHAR, 
	...
	((_CALL_(OnDeadChar))((TCHAR)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*260*/ MSG_TRANS(WM_SYSKEYDOWN, 
	...
	((_CALL_(OnSysKeyDown))((UINT)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*261*/ MSG_TRANS(WM_SYSKEYUP, 
	...
	((_CALL_(OnSysKeyUp))((UINT)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*262*/ MSG_TRANS(WM_SYSCHAR, 
	...
	((_CALL_(OnSysChar))((TCHAR)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
/*263*/ MSG_TRANS(WM_SYSDEADCHAR, 
	...
	((_CALL_(OnSysDeadChar))((TCHAR)(wParam), (int)(int16_t)LOWORD(lParam), HIWORD(lParam)), 0L))
